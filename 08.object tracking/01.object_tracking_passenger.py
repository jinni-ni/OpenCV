...
file_name = '../cv2/video/passenger_01.mp4'
output_name = '../cv2/video/output_passenger_01.avi'

net = cv2.dnn.readNet("../cv2/model/yolov3.weights", "../cv2/model/yolov3.cfg")
