...
face_model = '../cv2/model/res10_300x300_ssd_iter_140000.caffemodel'
face_prototxt = '../cv2/model/deploy.prototxt.txt'
age_model = '../cv2/model/age_net.caffemodel'
age_prototxt = '../cv2/model/age_deploy.prototxt'
gender_model = '../cv2/model/gender_net.caffemodel'
gender_prototxt = '../cv2/model/gender_deploy.prototxt'
