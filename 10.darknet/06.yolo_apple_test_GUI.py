...
height = 0
show_ratio = 1.0
file_name = "../cv2/custom/fruit10.jpg"
weight_name = "../cv2/model/custom-train-yolo_final.weights"
cfg_name = "../cv2/custom/custom-train-yolo.cfg"
classes_name = "../cv2/custom/classes.names"
...
def selectWeightFile():
    global weight_name
    weight_name =  filedialog.askopenfilename(initialdir = "../cv2/model",title = "Select Weight file",filetypes = (("weights files","*.weights"),("all files","*.*")))
